...
export default function SubscriptionContent() {
  return (
    <div className="w-full h-full rounded-2xl">
      ...
      <div
        className="w-full flex flex-col px-4 gap-6 animate-blur-up text-[#1b1b1eef]
        dark:text-[#E4E2E5]"
      >
        <div className="w-full flex flex-col">
          <span className="text-xl font-semibold">Plan Empresarial</span>

          <span>$149.999 / mes</span>
        </div>

        <div className="flex flex-col">
          <span className="text-xl font-semibold">Proximo Pago</span>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            dark:bg-[#F5F3F6] dark:text-black"
          >
            Cambiar plan
          </button>
          ...
          <div className="flex flex-col">
            <span
              className="text-xs text-[#1b1b1ee5]
            dark:text-[#e4e2e5ab]"
            >
