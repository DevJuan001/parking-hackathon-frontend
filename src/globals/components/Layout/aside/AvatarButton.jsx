...
export default function AvatarButton({ avatarOnClick }) {
  ...
  return (
    <button
      ...
      className="w-full h-auto flex items-center py-3 pl-6 gap-2 rounded-4xl text-[#75777E] transition cursor-pointer
    ...
    >
      ...
      <span className="max-w-48 text-ellipsis text-nowrap font-medium overflow-hidden">
